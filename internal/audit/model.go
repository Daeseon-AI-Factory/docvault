...
const (
	...
	ActionAlertAck               Action = "alert.acknowledge"
	ActionAlertRuleCreate        Action = "alert_rule.create"
	ActionMonitoringConfigChange Action = "monitoring_config.change"
	ActionTrackingAdd            Action = "tracking.add"
	ActionTrackingDelete         Action = "tracking.delete"
	ActionTwoFactorSetup         Action = "2fa.setup"
	ActionTwoFactorVerify        Action = "2fa.verify"
	ActionTwoFactorDisable       Action = "2fa.disable"
)
